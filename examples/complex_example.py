...
class App(vgkit.Window):
    def __init__(self):
        ...
        # configure window
        self.title("vgkit complex_example.py")
        ...
        self.sidebar_frame = vgkit.Frame(self, width=140)
        self.sidebar_frame.grid(row=0, column=0, rowspan=4, sticky="nsew")
        self.sidebar_frame.grid_rowconfigure(4, weight=1)
        self.logo_label = vgkit.Label(
            self.sidebar_frame, text="vgkit", font=vgkit.Font(size=20, weight="bold")
        )
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.sidebar_button_1 = vgkit.Button(
        ...
        self.appearance_mode_optionemenu = vgkit.OptionMenu(
            self.sidebar_frame,
            values=["Light", "Dark", "System"],
            command=self.change_appearance_mode_event,
        )
        self.appearance_mode_optionemenu.grid(row=6, column=0, padx=20, pady=(10, 10))
        self.scaling_label = vgkit.Label(
            self.sidebar_frame, text="UI Scaling:", anchor="w"
        )
        self.scaling_label.grid(row=7, column=0, padx=20, pady=(10, 0))
        self.scaling_optionemenu = vgkit.OptionMenu(
            self.sidebar_frame,
        ...
        self.entry = vgkit.Entry(self, placeholder_text="CTkEntry")
        self.entry.grid(
        ...
        # create textbox
        self.textbox = vgkit.Textbox(self, width=250)
        self.textbox.grid(row=0, column=1, padx=(20, 0), pady=(20, 0), sticky="nsew")

        # create tabview
        self.tabview = vgkit.Tabview(self, width=250)
        ...
        self.scrollable_frame = vgkit.ScrollableFrame(
        ...
        for i in range(100):
            switch = vgkit.Switch(master=self.scrollable_frame, text=f"CTkSwitch {i}")
            switch.grid(row=i, column=0, padx=10, pady=(0, 20))
            self.scrollable_frame_switches.append(switch)

        # create checkbox and switch frame
        self.checkbox_slider_frame = vgkit.Frame(self)
        self.checkbox_slider_frame.grid(
            row=1, column=3, padx=(20, 20), pady=(20, 0), sticky="nsew"
        )
        self.checkbox_1 = vgkit.CheckBox(master=self.checkbox_slider_frame)
        self.checkbox_1.grid(row=1, column=0, pady=(20, 0), padx=20, sticky="n")
        self.checkbox_2 = vgkit.CheckBox(master=self.checkbox_slider_frame)
        self.checkbox_2.grid(row=2, column=0, pady=(20, 0), padx=20, sticky="n")
        self.checkbox_3 = vgkit.CheckBox(master=self.checkbox_slider_frame)
    ...
    def open_input_dialog_event(self):
        dialog = vgkit.InputDialog(text="Type in a number:", title="CTkInputDialog")
        print("CTkInputDialog:", dialog.get_input())

    def change_appearance_mode_event(self, new_appearance_mode: str):
        vgkit.set_appearance_mode(new_appearance_mode)

    def change_scaling_event(self, new_scaling: str):
        new_scaling_float = int(new_scaling.replace("%", "")) / 100
        vgkit.set_widget_scaling(new_scaling_float)
