...
class CTkScrollbar(CTkBaseClass):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # color
        self._fg_color = (
            ThemeManager.theme["CTkScrollbar"]["fg_color"]
            if fg_color is None
        ...
        # shape
        self._corner_radius = (
            ThemeManager.theme["CTkScrollbar"]["corner_radius"]
            if corner_radius is None
            else corner_radius
        )
        self._border_spacing = (
            ThemeManager.theme["CTkScrollbar"]["border_spacing"]
    ...
    def _get_scrollbar_values_for_minimum_pixel_size(self):
        ...
        if self._orientation == "vertical":
            ...
            if (
                scrollbar_pixel_length < self._minimum_pixel_length
                ...
                corrected_end_value = (
                    self._end_value + (1 - self._end_value) * interval_extend_factor
                )
                corrected_start_value = (
                    self._start_value - self._start_value * interval_extend_factor
                )
