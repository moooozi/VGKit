...
class CTkSegmentedButton(CTkFrame):
    ...
    def __init__(
        ...
        text_color_selected: str | tuple[str, str] | None = None,
        text_color_unselected: str | tuple[str, str] | None = None,
        ...
        if text_color_selected is None:
            self._sb_text_color_selected = ThemeManager.theme["CTkSegmentedButton"].get(
                "text_color_selected", self._sb_text_color
            )
        else:
            self._sb_text_color_selected = self._check_color_type(text_color_selected)

        if text_color_unselected is None:
            self._sb_text_color_unselected = ThemeManager.theme["CTkSegmentedButton"].get(
                "text_color_unselected", self._sb_text_color
            )
        else:
    ...
    def configure(self, **kwargs):
        ...
        if "text_color_unselected" in kwargs:
            self._sb_text_color_unselected = self._check_color_type(
                kwargs.pop("text_color_unselected")
            )
            for value, button in self._buttons_dict.items():
                if value != self._current_value:
    ...
    def set(
        self, value: str, from_variable_callback: bool = False, from_button_callback: bool = False
    ):
        if value == self._current_value:
            return
