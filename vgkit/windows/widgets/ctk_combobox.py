...
class CTkComboBox(CTkBaseClass):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # shape
        self._corner_radius = (
            ThemeManager.theme["CTkComboBox"]["corner_radius"]
            if corner_radius is None
            else corner_radius
        )
        self._border_width = (
            ThemeManager.theme["CTkComboBox"]["border_width"]
    ...
    def _create_grid(self):
        ...
        self._entry.grid(
            ...
            padx=(
                ...
                max(
                    self._apply_widget_scaling(self._current_width - left_section_width + 3),
    ...
    def _draw(self, no_color_updates=False):
        ...
        if no_color_updates is False or requires_recoloring or requires_recoloring_2:
            ...
            if self._state == tkinter.DISABLED:
                self._canvas.itemconfig(
                    "dropdown_arrow", fill=self._apply_appearance_mode(self._text_color_disabled)
                )
            else:
                self._canvas.itemconfig(
    ...
    def _on_enter(self, event=0):
        if self._hover is True and self._state == tkinter.NORMAL and len(self._values) > 0:
            if (
                ...
                and self._cursor_manipulation_enabled
            ):
