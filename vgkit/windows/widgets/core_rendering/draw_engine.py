...
class DrawEngine:
    """
    This is the core of the vgkit library where all the drawing on the tkinter.Canvas happens.
    ...
    def set_round_to_even_numbers(
        self, round_width_to_even_numbers: bool = True, round_height_to_even_numbers: bool = True
    ):
    ...
    def draw_background_corners(
        ...
        if self._round_width_to_even_numbers:
            ...
            )  # round (floor) _current_width and _current_height and restrict them to even values only
        ...
        self._canvas.coords(
            "background_corner_bottom_right", (mid_width, mid_height, width, height)
        )
    ...
    def draw_rounded_rect_with_border(
        ...
        if preferred_drawing_method == "polygon_shapes":
            return self.__draw_rounded_rect_with_border_polygon_shapes(
                width, height, corner_radius, border_width, inner_corner_radius
            )
        elif preferred_drawing_method == "font_shapes":
            return self.__draw_rounded_rect_with_border_font_shapes(
                width, height, corner_radius, border_width, inner_corner_radius, ()
            )
    ...
    def __draw_rounded_rect_with_border_polygon_shapes(
        ...
        if border_width > 0:
            ...
            self._canvas.itemconfig(
                "border_line_1", joinstyle=tkinter.ROUND, width=corner_radius * 2
            )
        ...
        if not self._canvas.find_withtag("inner_parts"):
            self._canvas.create_polygon(
                (0, 0, 0, 0), tags=("inner_line_1", "inner_parts"), joinstyle=tkinter.ROUND
            )
            requires_recoloring = True
    ...
    def __draw_rounded_rect_with_border_font_shapes(
        ...
        if border_width > 0:
            if corner_radius > 0:
                ...
                self._canvas.coords(
                    "border_oval_2_a", width - corner_radius, corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_2_b", width - corner_radius, corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_3_a", width - corner_radius, height - corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_3_b", width - corner_radius, height - corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_4_a", corner_radius, height - corner_radius, corner_radius
                )
                self._canvas.coords(
                    "border_oval_4_b", corner_radius, height - corner_radius, corner_radius
                )
    ...
    def __draw_rounded_rect_with_border_circle_shapes(
            ...
            if corner_radius > 0:
                if not self._canvas.find_withtag("border_oval_1"):
                    self._canvas.create_oval(
                        ...
                        0,
                        0,
                        tags=("border_oval_1", "border_corner_part", "border_parts"),
                        width=0,
                    )
                    self._canvas.create_oval(
                        0,
                        ...
                        0,
                        0,
                        tags=("border_oval_2", "border_corner_part", "border_parts"),
                        width=0,
                    )
                    self._canvas.create_oval(
                        0,
                        ...
                        0,
                        0,
                        tags=("border_oval_3", "border_corner_part", "border_parts"),
                        width=0,
                    )
                    self._canvas.create_oval(
                        0,
                        ...
                        0,
                        0,
                        tags=("border_oval_4", "border_corner_part", "border_parts"),
                        width=0,
                    )
                    self._canvas.tag_lower("border_parts")
                    requires_recoloring = True
                ...
                self._canvas.coords(
                    "border_oval_1", 0, 0, corner_radius * 2 - 1, corner_radius * 2 - 1
                )
                self._canvas.coords(
                    "border_oval_2", width - corner_radius * 2, 0, width - 1, corner_radius * 2 - 1
                )
                self._canvas.coords(
                    "border_oval_3",
                    0,
        ...
        if inner_corner_radius > 0:
            if not self._canvas.find_withtag("inner_oval_1"):
                self._canvas.create_oval(
                    0, 0, 0, 0, tags=("inner_oval_1", "inner_corner_part", "inner_parts"), width=0
                )
                self._canvas.create_oval(
                    0, 0, 0, 0, tags=("inner_oval_2", "inner_corner_part", "inner_parts"), width=0
                )
                self._canvas.create_oval(
                    0, 0, 0, 0, tags=("inner_oval_3", "inner_corner_part", "inner_parts"), width=0
                )
                self._canvas.create_oval(
                    0, 0, 0, 0, tags=("inner_oval_4", "inner_corner_part", "inner_parts"), width=0
                )
            ...
            self._canvas.coords(
                "inner_oval_2",
                (
                    width - border_width - inner_corner_radius * 2,
                    border_width,
    ...
    def draw_rounded_rect_with_border_vertical_split(
        ...
        if (
            ...
            return self.__draw_rounded_rect_with_border_vertical_split_polygon_shapes(
                width, height, corner_radius, border_width, inner_corner_radius, left_section_width
            )
        elif self.preferred_drawing_method == "font_shapes":
            return self.__draw_rounded_rect_with_border_vertical_split_font_shapes(
                width,
                height,
                corner_radius,
                border_width,
    ...
    def __draw_rounded_rect_with_border_vertical_split_polygon_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if border_width > 0:
            if not self._canvas.find_withtag("border_parts"):
                self._canvas.create_polygon(
                    (0, 0, 0, 0),
                    tags=("border_line_left_1", "border_parts_left", "border_parts", "left_parts"),
                )
                self._canvas.create_polygon(
                    (0, 0, 0, 0),
                    tags=(
                ...
                self._canvas.create_rectangle(
                    (0, 0, 0, 0),
                    tags=("border_rect_left_1", "border_parts_left", "border_parts", "left_parts"),
                    width=0,
                )
                self._canvas.create_rectangle(
                    (0, 0, 0, 0),
            ...
            self._canvas.coords(
                "border_rect_left_1",
                (left_section_width - corner_radius, 0, left_section_width, height),
            )
            self._canvas.coords(
                "border_rect_right_1",
                (left_section_width, 0, left_section_width + corner_radius, height),
            )
            self._canvas.itemconfig(
                "border_line_left_1", joinstyle=tkinter.ROUND, width=corner_radius * 2
            )
            self._canvas.itemconfig(
                "border_line_right_1", joinstyle=tkinter.ROUND, width=corner_radius * 2
            )
        ...
        if not self._canvas.find_withtag("inner_parts"):
            ...
            self._canvas.create_rectangle(
                (0, 0, 0, 0),
                tags=("inner_rect_right_1", "inner_parts_right", "inner_parts", "right_parts"),
                width=0,
            )
            requires_recoloring = True
    ...
    def __draw_rounded_rect_with_border_vertical_split_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if border_width > 0:
            ...
            self._canvas.coords(
                "border_rectangle_left_2", (corner_radius, 0, left_section_width, height)
            )
            self._canvas.coords(
                "border_rectangle_right_1",
            ...
            self._canvas.coords(
                "border_rectangle_right_2", (left_section_width, 0, width - corner_radius, height)
            )
    ...
    def __draw_rounded_progress_bar_with_border_polygon_shapes(
        ...
        if corner_radius <= border_width:
            bottom_right_shift = (
                0  # weird canvas rendering inaccuracy that has to be corrected in some cases
            )
        else:
            bottom_right_shift = 0
        ...
        if not self._canvas.find_withtag("progress_parts"):
            self._canvas.create_polygon(
                (0, 0, 0, 0), tags=("progress_line_1", "progress_parts"), joinstyle=tkinter.ROUND
            )
    ...
    def __draw_rounded_progress_bar_with_border_font_shapes(
        ...
        if inner_corner_radius > 0:
            ...
            if (
                ...
                and round(inner_corner_radius) * 2 < height - 2 * border_width
            ):
                self._canvas.create_aa_circle(
                    0,
                    0,
                ...
                and not round(inner_corner_radius) * 2 < height - 2 * border_width
            ):
                self._canvas.delete(
                    "progress_oval_3_a",
                    "progress_oval_3_b",
    ...
    def draw_rounded_slider_with_border_and_button(
        ...
        corner_radius: float | int,
        border_width: float | int,
        button_length: float | int,
        button_corner_radius: float | int,
        slider_value: float,
        orientation: str,
    ) -> bool:
        ...
        if (
            ...
            return self.__draw_rounded_slider_with_border_and_button_font_shapes(
                width,
                height,
                corner_radius,
                border_width,
    ...
    def __draw_rounded_slider_with_border_and_button_polygon_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if not self._canvas.find_withtag("slider_parts"):
            self._canvas.create_polygon(
                (0, 0, 0, 0), tags=("slider_line_1", "slider_parts"), joinstyle=tkinter.ROUND
            )
    ...
    def __draw_rounded_slider_with_border_and_button_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if not self._canvas.find_withtag("slider_oval_1_a"):
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_1_a", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_1_b", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_2_a") and button_length > 0:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_2_a", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_b", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_4_a") and height > 2 * button_corner_radius:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_4_a", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_4_b", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if (
            ...
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_3_a", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_3_b", "slider_corner_part", "slider_parts"),
                anchor=tkinter.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_rectangle_1") and button_length > 0:
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_1", "slider_rectangle_part", "slider_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if (
            ...
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_2", "slider_rectangle_part", "slider_parts"),
                width=0,
            )
            requires_recoloring = True
        elif (
    ...
    def draw_rounded_scrollbar(
        ...
        if (
            ...
            return self.__draw_rounded_scrollbar_polygon_shapes(
                width,
                height,
                corner_radius,
                inner_corner_radius,
            ...
            return self.__draw_rounded_scrollbar_font_shapes(
                width,
                height,
                corner_radius,
                inner_corner_radius,
    ...
    def __draw_rounded_scrollbar_polygon_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if not self._canvas.find_withtag("border_parts"):
            self._canvas.create_rectangle(
                0, 0, 0, 0, tags=("border_rectangle_1", "border_parts"), width=0
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("scrollbar_parts"):
            self._canvas.create_polygon(
                (0, 0, 0, 0),
                tags=("scrollbar_polygon_1", "scrollbar_parts"),
                joinstyle=tkinter.ROUND,
            )
    ...
    def __draw_rounded_scrollbar_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if inner_corner_radius > 0:
            ...
            if (
                not self._canvas.find_withtag("scrollbar_oval_3_a")
                and height > 2 * corner_radius
                and width > 2 * corner_radius
            ):
                self._canvas.create_aa_circle(
    ...
    def draw_dropdown_arrow(
        self, x_position: int | float, y_position: int | float, size: int | float
    ) -> bool:
