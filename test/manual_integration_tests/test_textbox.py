...
# vgk.set_widget_scaling(0.9)
# vgk.set_window_scaling(0.9)
...
textbox_1 = vgk.Textbox(app, fg_color=None, corner_radius=0, border_spacing=0)
...
textbox_2 = vgk.Textbox(frame_1, wrap="none", corner_radius=30)
...
textbox_2 = vgk.Textbox(frame_1, wrap="none", corner_radius=0, border_width=30)
...
textbox_2 = vgk.Textbox(frame_1, wrap="none", corner_radius=60, border_width=15)
...
textbox_2 = vgk.Textbox(frame_1, wrap="none", corner_radius=0, border_width=0)
...
textbox_3 = vgk.Textbox(frame_2, corner_radius=30)
...
textbox_3 = vgk.Textbox(frame_2, corner_radius=0, border_width=30)
...
textbox_3 = vgk.Textbox(frame_2, corner_radius=60, border_width=15)
...
textbox_3 = vgk.Textbox(frame_2, corner_radius=0, border_width=0, border_spacing=20)
...
frame_3 = vgk.Container(app, corner_radius=0, fg_color=None)
...
textbox_3 = vgk.Textbox(frame_3, activate_scrollbars=False)
textbox_3.grid(row=0, column=0, sticky="nsew", padx=20, pady=20)
textbox_3.insert(
    "0.0",
    "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.\n\n"
...
textbox_4 = vgk.Textbox(app, fg_color=None, corner_radius=0)
...
scrollbar4 = vgk.Scrollbar(app, command=textbox_4.yview)
scrollbar4.grid(row=0, column=5, sticky="nsew")
textbox_4.configure(yscrollcommand=scrollbar4.set)

# app.after(3000, lambda: vgk.set_appearance_mode("light"))
app.mainloop()
